...
category_numbers = st.text_area("Codes:", "1\n2\n3")
category_names = st.text_area("Kategorien:", 'Kategorie für Code 1\nKategorie für Code 2\nKategorie für Code 3')
search_words = st.text_area("Suchwörter:", 'Offene Nennungen untereinander einfügen\n...\n...\n...')
